...
export function SubscribeBlock() {
  return (
    <div className={style.subscribeBlock}>
      <div className={style.subscribeBlock__container}>
        <div className={style.subscribeBlock__textBlock}>
          <h3>Скорее подпишись </h3>
          <div>
            <p>
              Оформи подписку прямо сейчас и открой доступ к более чем 100
              эксклюзивным рецептам, которые недоступны на бесплатном
              тарифе!{" "}
            </p>
            <p>
        ...
        <div className={style.subscribeBlock__imageBlock}>
